...
QUESTION_SLICE: list[str] = [
    ...
    "ai-system-design/14-chatgpt-style-conversational-service.md",
    "ai-system-design/15-ai-coding-assistant.md",
    "ai-system-design/16-llm-customer-support-assistant.md",
    ...
    "cloud-architecture/07-llm-gateway-semantic-cache-model-router.md",
    ...
    "general-system-design/08-notification-system.md",
    "general-system-design/09-url-shortener.md",
    "general-system-design/10-video-streaming-platform.md",
    "general-system-design/11-web-crawler.md",
    ...
    "behavioral/06-influence-without-authority.md",
    "behavioral/07-technical-bet-that-failed.md",
    ...
    "coding/11-consistent-hashing.md",
    "coding/12-elevator-system-lld.md",
    "coding/13-parking-lot-lld.md",
